...
#     --model_path /home/omote/omote-data-ssd/iam-llms-finetune/original_model_weight/paligemma-3b-pt-896 \
...
#     --gen_args_folder temperature=1.0-top_p=1.0-top_k=50-num_beams=1-do_sample=False- \
#     --other_command="--model,paligemma,-gt,/data_ssd/refcoco_g/refcoco_g_paligemma_validation.json" \
#     --wandb_make_run \
#     --wandb_run_name zero-shot-896px \
